...
serve(async (req) => {
  ...
  try {
    ...
    if (hasActiveSub) {
      ...
      // Subscription tier is based on the product ID
      productId = subscription.items.data[0].price.product as string;
      
      // Map product IDs to tiers
      const tierMapping: Record<string, string> = {
        'prod_T7Ih26ZMAehp3r': 'professional', // SupportBots Professional
        'prod_T7IkTHwZAItNtS': 'enterprise'    // SupportBots Enterprise
      };
