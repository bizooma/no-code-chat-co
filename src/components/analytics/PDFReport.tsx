  ...
  const generatePDFReport = async () => {
    try {
      ...
      const htmlContent = `
        ...
        <head>
          <meta charset="utf-8">
          <title>SupportBots Analytics Report</title>
          <style>
            body {
        ...
        <body>
          ...
          <div class="footer">
            <p>Generated by SupportBots Analytics Platform</p>
            <p>For more detailed insights, visit your dashboard at app.supportbots.com</p>
          </div>
        </body>
        </html>
      `;
